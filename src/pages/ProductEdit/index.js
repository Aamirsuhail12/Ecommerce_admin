...
const ProductEdit = () => {
    ...
    const handleChange3 = (event) => {
        console.log('Sub Category id : ', event.target.value)
    ...
    const SubCategoryList = async () => {
        ...
        try {
            ...
            console.log('Sub cat', response.data.subcategory)
    ...
    const GetEditProduct = async () => {
        ...
        try {
            ...
            console.log("This is edit product.", response.data);
            setProduct({ ...product, ...response.data, category: response.data.category._id, subcategory: response.data.subcategory._id });
        } catch (error) {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-wrap justify-between items-center gap-3">
                            ...
                            <div className="w-[30%]">
                                ...
                                <input type="text" onChange={handleWeight} name='weight' value={product.weight} className="w-full h-[60px] bg-gray-100 outline-none border-2 p-4 rounded-[5px]" />
                            </div>

                            <div className=" w-[30%]">
                                <h1 className=" text-[20px] my-2">RAM</h1>
                                <Select
                                    multiple
                                    labelId="demo-simple-select-label"
                                    id="RAM"
                            ...
                            <div className=" w-[30%]">
                                <h1 className=" text-[20px] my-2">Size</h1>
                                <Select
                                    multiple
                                    labelId="demo-simple-select-label"
                                    id="size"
